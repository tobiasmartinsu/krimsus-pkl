...
<div class="card">
    <div class="card-body">
        <a href="/pelaporan3/create" class="btn btn-primary btn-sm my-3">Tambah Pelaporan</a>
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    @forelse ($pelaporan3 as $key=>$value)
                    <tr>
                        ...
                        <td>
                            <form action="/pelaporan3/{{$value->id}}" method="POST" id="form-delete">
                                @method('delete')
                                @csrf
                                <a href="/pelaporan3/{{$value->id}}/edit" class="btn btn-warning btn-sm mb-2">Edit</a>
