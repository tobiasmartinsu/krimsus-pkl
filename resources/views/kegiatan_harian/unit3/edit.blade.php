...
@section('title')
    Halaman Edit Kegiatan Harian Unit 3
@endsection
@section('content')
    <form action="/kegiatanharian3/{{$kegiatanharian3->id}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('put')
        ...
        <div class="form-group">
            ...
            <select name="name" class="form-control text-dark" value="{{$kegiatanharian3->name}}" id='name'>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control text-dark" value="{{$kegiatanharian3->nama_kegiatan}}" name="nama_kegiatan" placeholder="Masukkan Nama Aduan">
            @error('nama_kegiatan')
                <div class="alert alert-danger">
                    {{ $message }}
                </div>
        ...
        <div class="form-group">
            <label>Tanggal</label>
            <input type="date" class="form-control text-dark" value="{{$kegiatanharian3->tanggal}}" name="tanggal" placeholder="Masukkan Tanggal">
            @error('tanggal')
                <div class="alert alert-danger">
                    {{ $message }}
                </div>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control text-dark" name="detail_kegiatan"  placeholder="Masukkan Detail Kegiatan" cols="30"
                rows="10">{{$kegiatanharian3->detail_kegiatan}}</textarea>
