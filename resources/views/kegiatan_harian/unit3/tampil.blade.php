...
@section('title')
    Halaman Kegiatan Harian Unit 3
@endsection
@section('content')
<div class="col">
    <a href="/kegiatanharian3/create" class="btn btn-info btn-md my-3">Tambah Kegiatan</a>
</div>

    <div class="row">
        @forelse ($kegiatanharian3 as $item)
        <div class="col-4">
            <div class="card">
                ...
                <div class="card-body" style="height: 300px">
                    ...
                    <a href="/kegiatanharian3/{{$item->id}} " class="btn btn-outline-primary btn-block">Lihat Lebih Lengkap</a>
                    <div class="row mt-3">
                        <div class="col">
                            <a href="/kegiatanharian3/{{$item->id}}/edit" class="btn btn-warning btn-block">Edit</a>
                        </div>
                        <div class="col">
                            <form action="/kegiatanharian3/{{$item->id}}" method="post" id="form-delete">
                            @csrf
                            @method('delete')
